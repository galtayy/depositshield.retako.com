  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Protect your rental deposit with DepositShield" />
      ...
      >
        ...
        {/* Progress bar - hidden for first screen based on design */}
        <div className="w-full px-4 mt-2" style={{ display: 'none' }}>
          <div className="w-full h-1 bg-[#D1E7D5] rounded-full">
            <div className="h-full w-1/5 bg-[#55A363] rounded-full"></div>
          </div>
        </div>
        ...
        <div className="absolute w-[350px] h-[56px] left-1/2 transform -translate-x-1/2 bottom-[40px]">
          <Link href="/onboarding/step2" className="w-full">
