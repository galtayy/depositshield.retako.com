  ...
  return (
    <>
      <Head>
        ...
        `}</style>
        <title>Document Before You Decorate</title>
        ...
        <meta name="description" content="Document your property before decorating with DepositShield" />
      ...
      >
        ...
        <div className="absolute w-[350px] h-[56px] left-1/2 transform -translate-x-1/2 bottom-[40px]">
          <Link href="/onboarding/step4" className="w-full">
