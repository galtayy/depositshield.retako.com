  ...
  return (
    <>
      <Head>
        ...
        `}</style>
        <title>Tag What's Already Damaged</title>
        ...
        <meta name="description" content="Document existing damage with DepositShield" />
      ...
      >
        ...
        <div className="absolute top-[190px] left-0 right-0 px-4">
        ...
        <div className="absolute w-[350px] h-[56px] left-1/2 transform -translate-x-1/2 bottom-[40px]">
          <Link href="/onboarding/step5" className="w-full">
